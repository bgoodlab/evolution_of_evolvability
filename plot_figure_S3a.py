...
def run():
    ...
    plt.figure(figsize=(10,12)); plt.xlabel("$s_{b}'/s_{b}$",fontsize=50,labelpad=15); plt.ylabel(r"$ \tilde{p}_{fix}(s_{b} \to s_{b}' \to s_{b})$",fontsize=50,labelpad=15); plt.yscale('log');
