...
def run():
    ...
    plt.figure(figsize=(10,8)); plt.xlabel("$U_{d}'$",fontsize=50,labelpad=15); plt.ylabel(r"$ \tilde{p}_{fix}(U_{d},s_{b} \to U_{d}',s_{b}')$",fontsize=50,labelpad=15); plt.yscale('log'); plt.xscale('log')
